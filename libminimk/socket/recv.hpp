// File: libminimk/socket/recv.hpp
// Purpose: recv implementation
// SPDX-License-Identifier: GPL-3.0-or-later
#ifndef LIBMINIMK_SOCKET_RECV_HPP
#define LIBMINIMK_SOCKET_RECV_HPP
...
minimk_error_t minimk_socket_recv_impl(minimk_socket_t sock, void *data, size_t count, size_t *nread) noexcept {
    ...
    for (;;) {
        ...
        *nread = 0;
        rv = M_recv(info->fd, data, count, nread);
        ...
        rv = M_suspend_read(info->fd, info->read_timeout);
        if (rv != 0) {
...
#endif // LIBMINIMK_SOCKET_RECV_HPP
