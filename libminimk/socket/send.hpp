// File: libminimk/socket/send.hpp
// Purpose: send implementation
// SPDX-License-Identifier: GPL-3.0-or-later
#ifndef LIBMINIMK_SOCKET_SEND_HPP
#define LIBMINIMK_SOCKET_SEND_HPP
...
MINIMK_ALWAYS_INLINE minimk_error_t minimk_socket_send_impl(minimk_socket_t sock, const void *data,
    ...
    for (;;) {
        ...
        *nwritten = 0;
        rv = M_send(info->fd, data, count, nwritten);
...
#endif // LIBMINIMK_SOCKET_SEND_HPP
