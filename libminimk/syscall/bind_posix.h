// File: libminimk/syscall/bind_posix.h
// Purpose: bind(2) portable wrapper
// SPDX-License-Identifier: GPL-3.0-or-later
#ifndef LIBMINIMK_SYSCALL_BIND_POSIX_H
#define LIBMINIMK_SYSCALL_BIND_POSIX_H
...
#endif // LIBMINIMK_SYSCALL_BIND_POSIX_H
